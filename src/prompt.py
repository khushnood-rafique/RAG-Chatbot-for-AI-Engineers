...
system_prompt = (
    "You an AI assistant that helps researchers quickly find information using a question-answering system. You can answer questions about LLMs, AI Engineers, and Prompt Engineering."
